...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'dakotaContigFilter'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from dakotaContigFilter.dakotaContigFilterImpl import dakotaContigFilter  # noqa @IgnorePep8
impl_dakotaContigFilter = dakotaContigFilter(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'dakotaContigFilter'
        ...
        self.rpc_service.add(impl_dakotaContigFilter.run_dakotaContigFilter,
